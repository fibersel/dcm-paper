...
\begin{lstlisting}[
  language=C++,
  morekeywords={NodeContainer,PointToPointHelper,InternetStackHelper,
    TrafficControlHelper,RedQueueDisc,Config,SetAttribute}
]
...
\begin{lstlisting}[
  language=C++,
  morekeywords={BulkSendHelper,PacketSinkHelper,ApplicationContainer,
    InetSocketAddress,Seconds}
]
...
\begin{lstlisting}[
  language=C++,
  morekeywords={Simulator,Callback,QueueDisc,Ptr,ofstream,Seconds,
    ScheduleEvery}
]
